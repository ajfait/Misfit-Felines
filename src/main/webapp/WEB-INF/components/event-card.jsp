                ...
                <div class="row d-flex">
                    <div class="col-md-6">
                        ...
                        <div class="container-fluid pt-3">
                            ...
                            <p><strong>Location:</strong> ${event.eventLocationStreet}, ${event.eventLocationCity}, ${event.eventLocationState} ${event.eventLocationZip}
                            </p>
                            <p><strong>Date & Time:</strong> ${event.eventDateTimeStart} - ${event.eventDateTimeEnd}</p>
                        </div>
                    </div>
                </div>
                <!-- Buttons -->
