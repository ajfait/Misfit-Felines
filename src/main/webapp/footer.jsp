<footer>
    <div class="row bg-primary p-5">
        ...
        <div class="col-md-3">
            <table>
                <tr>
                    <td class="text-white font-weight-bold text-uppercase">Contact Us</td>
                </tr>
                <tr>
                    <td class="text-white">Phone:</td>
                    <td class="text-white">(715) 383-8927</td>
                </tr>
                <tr>
        ...
        <div class="col-md-2">
            <table>
                <tr>
                    <td class="text-end text-white font-weight-bold text-uppercase">Donate</td>
                </tr>
                <tr>
